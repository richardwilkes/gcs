 ...
 * <CODE>Section</CODE>s, <CODE>Paragraph</CODE>s, <CODE>List</CODE> and/or <CODE>Table</CODE>s.
 * <P>
 * Remark: you can not construct a <CODE>Section</CODE> yourself. You will have to ask an instance
 * of <CODE>Section</CODE> to the <CODE>Chapter</CODE> or <CODE>Section</CODE> to which you want to
...
public class Section extends ArrayList implements TextElementArray, LargeElement {
	 ...
	 *
	 * @return <CODE>true</CODE> if it is a <CODE>Chapter</CODE>, <CODE>false</CODE> if it is a
	 *         <CODE>Section</CODE>.
	 */
	 ...
	 *
	 * @return <CODE>true</CODE> if it is a <CODE>Section</CODE>, <CODE>false</CODE> if it is a
	 *         <CODE>Chapter</CODE>.
	 */
	...
	/**
	 * Adds a <CODE>Paragraph</CODE>, <CODE>List</CODE> or <CODE>Table</CODE> to this
	 * <CODE>Section</CODE>.
	 *
	 * @param index index at which the specified element is to be inserted
	 * @param o an object of type <CODE>Paragraph</CODE>, <CODE>List</CODE> or <CODE>Table</CODE>=
	 * @throws ClassCastException if the object is not a <CODE>Paragraph</CODE>, <CODE>List</CODE>
	 *             or <CODE>Table</CODE>
	 */
	@Override
	...
	/**
	 * Adds a <CODE>Paragraph</CODE>, <CODE>List</CODE>, <CODE>Table</CODE> or another
	 * <CODE>Section</CODE> to this <CODE>Section</CODE>.
	 *
	 * @param o an object of type <CODE>Paragraph</CODE>, <CODE>List</CODE>, <CODE>Table</CODE> or
	 *            another <CODE>Section</CODE>
	 * @return a boolean
	 * @throws ClassCastException if the object is not a <CODE>Paragraph</CODE>, <CODE>List</CODE>,
	 *             <CODE>Table</CODE> or <CODE>Section</CODE>
	 */
	@Override
	 ...
	 *
	 * @param collection a collection of <CODE>Paragraph</CODE>s, <CODE>List</CODE>s and/or
	 *            <CODE>Table</CODE>s
	 * @return <CODE>true</CODE> if the action succeeded, <CODE>false</CODE> if not.
	 * @throws ClassCastException if one of the objects isn't a <CODE>Paragraph</CODE>,
	 ...
	 * <P>
	 * If the numberdepth is 0, the sections will not be numbered. If the numberdepth is 1, the
	 * section will be numbered with their own number. If the numberdepth is higher (for instance x
	 * > 1), the numbers of x - 1 parents will be shown.
	 *
	...
	/**
	 * Sets the style for numbering sections. Possible values are NUMBERSTYLE_DOTTED: 1.2.3. (the
	 * default) or NUMBERSTYLE_DOTTED_WITHOUT_FINAL_DOT: 1.2.3
	 * 
	 * @since iText 2.0.8
	 */
	...
	/**
	 * Sets the bookmark title. The bookmark title is the same as the section title but can be
