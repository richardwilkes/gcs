...
public class Paragraph extends Phrase {
	 ...
	 * is the font of all the elements that make part of the paragraph. This isn't necessarily true.
	 * 
	 ...
	 *
	 * @return the spacing
	 * @deprecated As of iText 2.1.5, replaced by {@link #getSpacingBefore()}, scheduled for removal
	 *             at 2.3.0
	 */
	@Deprecated
	 ...
	 *
	 * @return the spacing
	 * @deprecated As of iText 2.1.5, replaced by {@link #getSpacingAfter()}, scheduled for removal
	 *             at 2.3.0
	 */
	@Deprecated
