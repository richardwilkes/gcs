 ...
 * <LI>When you change the header/footer on a certain page, this will be effective starting on the
 * next page.
...
public class Document implements DocListener {
	...
	/**
	 * Gets the release number. This method may only be changed by Paulo Soares and/or Bruno
	 * Lowagie.
	 * 
	 * @return the product name
	 * @since 2.1.6
