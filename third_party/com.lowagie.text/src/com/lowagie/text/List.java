 ...
 * </PRE>
 * 
 * </BLOCKQUOTE> The result of this code looks like this:
 * <OL>
 * <LI>First line</LI>
 * <LI>The second line is longer to see what happens once the end of the line is reached. Will it
 * start on a new line?</LI>
 * <LI>Third line</LI>
 * </OL>
...
public class List implements TextElementArray {
	 ...
	 * Constructs a <CODE>List</CODE>.
	 * <P>
	 * Remark: the parameter <VAR>symbolIndent</VAR> is important for instance when generating
	 * PDF-documents; it indicates the indentation of the listsymbol. It is not important for
	 * HTML-documents.
	 *
	 * @param numbered a boolean
	 ...
	 * 
	 * @since iText 2.1.1
	 * @param postSymbol the String that has to be added after a number or letter in the list
	 *            symbol.
	 */
	 ...
	 * 
	 * @since iText 2.1.1
	 * @param preSymbol the String that has to be added before a number or letter in the list
	 *            symbol.
	 */
