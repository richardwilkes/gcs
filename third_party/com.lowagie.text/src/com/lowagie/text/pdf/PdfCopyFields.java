...
/**
 * Concatenates PDF documents including form fields. The rules for the form field concatenation are
 * the same as in Acrobat. All the documents are kept in memory unlike PdfCopy.
 *
 * @author Paulo Soares (psoares@consiste.pt)
 */
public class PdfCopyFields implements PdfViewerPreferences {
	 ...
	 * <CODE>List</CODE> of <CODE>Integer</CODE>. The page ordering can be changed but no page
	...
	/**
	 * Sets the bookmarks. The list structure is defined in <CODE>SimpleBookmark#</CODE>.
	 *
