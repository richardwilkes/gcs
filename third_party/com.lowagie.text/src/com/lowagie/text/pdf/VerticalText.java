...
/**
 * Writes text vertically. Note that the naming is done according to horizontal text although it
 * refers to vertical text. A line with the alignment Element.LEFT_ALIGN will actually be top
 * aligned.
 */
...
public class VerticalText {
	...
	/**
	 * Gets the X coordinate where the next line will be written. This value will change after each
	 * call to <code>go()</code>.
	 * 
	...
	/**
	 * Gets the maximum number of available lines. This value will change after each call to
	 * <code>go()</code>.
	 * 
