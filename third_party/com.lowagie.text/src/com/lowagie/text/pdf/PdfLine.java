...
public class PdfLine {
	 ...
	 * @return <CODE>null</CODE> if the chunk could be added completely; if not a
	 *         <CODE>PdfChunk</CODE> containing the part of the chunk that could not be added is
	 *         returned
	 */
	...
	/**
	 * Gets the difference between the "normal" leading and the maximum size (for instance when
	 * there are images in the chunk).
	 * 
