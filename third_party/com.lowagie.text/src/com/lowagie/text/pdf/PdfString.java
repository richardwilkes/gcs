 ...
 * <P>
 * A string is a sequence of characters delimited by parenthesis. If a string is too long to be
 * conveniently placed on a single line, it may be split across multiple lines by using the
 * backslash character (\) at the end of a line to indicate that the string continues on the
 * following line. Within a string, the backslash character is used as an escape to specify
 * unbalanced parenthesis, non-printing ASCII characters, and the backslash character itself. Use of
 * the \<I>ddd</I> escape sequence is the preferred way to represent characters outside the
 * printable ASCII character set.<BR>
...
public class PdfString extends PdfObject {
	...
	/**
	 * Writes the PDF representation of this <CODE>PdfString</CODE> as an array of <CODE>byte</CODE>
	...
	/**
	 * Returns the Unicode <CODE>String</CODE> value of this <CODE>PdfString</CODE>-object.
	 *
	 * @return A <CODE>String</CODE>
	 */
