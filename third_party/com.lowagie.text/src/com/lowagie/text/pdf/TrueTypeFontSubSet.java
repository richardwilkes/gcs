...
class TrueTypeFontSubSet {
	 ...
	 * is an <CODE>int[3]</CODE> where position 0 is the checksum, position 1 is the offset from the
	 * start of the file and position 2 is the length of the table.
	 */
	 ...
	 * @param includeCmap <CODE>true</CODE> if the table cmap is to be included in the generated
	 *            font
	 */
