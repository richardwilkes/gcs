...
public class PdfCopy extends PdfWriter {
	 ...
	 * PRIndirectObjects) really need to know what file they came from, because each file has its
	 * own namespace. The translation we do from their namespace to ours is *at best* heuristic, and
	...
	/**
	 * Translate a PRDictionary to a PdfDictionary. Also translate all of the objects contained in
	 * it.
	 */
	...
	/**
	 * Copy the acroform for an input document. Note that you can only have one, we make no effort
	 * to merge them.
	 * 
	...
	/**
	 * Create a page stamp. New content and annotations, including new fields, are allowed. The
	 * fields added cannot have parents in another pages. This method modifies the PdfReader
	 * instance.
	 * <p>
	...
	public static class StampContent extends PdfContentByte {
		...
		/**
		 * Gets a duplicate of this <CODE>PdfContentByte</CODE>. All the members are copied by
		 * reference but the buffer stays different.
		 *
