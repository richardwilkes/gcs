 ...
 * <P>
 * A dictionary is an associative table containing pairs of objects. The first element of each pair
 * is called the <I>key</I> and the second element is called the <I>value</I>. Unlike dictionaries
 * in the PostScript language, a key must be a <CODE>PdfName</CODE>. A value can be any kind of
 * <CODE>PdfObject</CODE>, including a dictionary. A dictionary is generally used to collect and tie
 * together the attributes of a complex object, with each key-value pair specifying the name and
 * value of an attribute.<BR>
 * A dictionary is represented by two left angle brackets (<<), followed by a sequence of key-value
 * pairs, followed by two right angle brackets (>>).<BR>
...
public class PdfDictionary extends PdfObject {
	...
	/**
	 * Writes the PDF representation of this <CODE>PdfDictionary</CODE> as an array of
	 * <CODE>byte</CODE> to the given <CODE>OutputStream</CODE>.
	 * 
	...
	/**
	 * Returns a string representation of this <CODE>PdfDictionary</CODE>. The string doesn't
	 * contain any of the content of this dictionary. Rather the string "dictionary" is returned,
	...
	/**
	 * Associates the specified <CODE>PdfObject</CODE> as <VAR>value</VAR> with the specified
	 * <CODE>PdfName</CODE> as <VAR>key</VAR> in this map. If the map previously contained a mapping
	 * for this <VAR>key</VAR>, the old <VAR>value</VAR> is replaced. If the <VAR>value</VAR> is
	 ...
	 * <CODE>PdfName</CODE> as key in this map. If the <VAR>value</VAR> is a <CODE>PdfNull</CODE>,
	 * it is treated just as any other <CODE>PdfObject</CODE>. If the <VAR>value</VAR> is
	 * <CODE>null</CODE> however nothing is done.
	 *
	 * @param key a <CODE>PdfName</CODE>
	 * @param value the <CODE>PdfObject</CODE> to be associated to the <VAR>key</VAR>
	 */
	...
	/**
	 * Copies all of the mappings from the specified <CODE>PdfDictionary</CODE> to this
	 * <CODE>PdfDictionary</CODE>. These mappings will replace any mappings previously contained in
	 * this <CODE>PdfDictionary</CODE>.
	 * 
	...
	/**
	 * Removes a <CODE>PdfObject</CODE> and its <VAR>key</VAR> from the <CODE>PdfDictionary</CODE>.
	 *
	 * @param key a <CODE>PdfName</CODE>
	 */
	...
	/**
	 * Returns the <CODE>PdfObject</CODE> associated to the specified <VAR>key</VAR>.
	 *
	 * @param key a <CODE>PdfName</CODE>
	 * @return the </CODE>PdfObject</CODE> previously associated to the <VAR>key</VAR>
	 */
	 ...
	 * possible indirect reference to a direct object. This method will never return a
	...
	/**
	 * Returns <CODE>true</CODE> if this <CODE>PdfDictionary</CODE> contains a mapping for the
	 ...
	 * references. The object associated with the <CODE>PdfName</CODE> given is retrieved and
	 * resolved to a direct object. If it is a <CODE>PdfDictionary</CODE>, it is cast down and
	 ...
	 * The object associated with the <CODE>PdfName</CODE> given is retrieved and resolved to a
	 ...
	 * The object associated with the <CODE>PdfName</CODE> given is retrieved and resolved to a
	 * direct object. If it is a <CODE>PdfStream</CODE>, it is cast down and returned as such.
	 * Otherwise <CODE>null</CODE> is returned.
	 * 
	 * @param key A <CODE>PdfName</CODE>
	 ...
	 * The object associated with the <CODE>PdfName</CODE> given is retrieved and resolved to a
	 * direct object. If it is a <CODE>PdfString</CODE>, it is cast down and returned as such.
	 * Otherwise <CODE>null</CODE> is returned.
	 * 
	 * @param key A <CODE>PdfName</CODE>
	 ...
	 * The object associated with the <CODE>PdfName</CODE> given is retrieved and resolved to a
	 * direct object. If it is a <CODE>PdfNumber</CODE>, it is cast down and returned as such.
	 * Otherwise <CODE>null</CODE> is returned.
	 * 
	 * @param key A <CODE>PdfName</CODE>
	 ...
	 * The object associated with the <CODE>PdfName</CODE> given is retrieved and resolved to a
	 * direct object. If it is a <CODE>PdfName</CODE>, it is cast down and returned as such.
	 * Otherwise <CODE>null</CODE> is returned.
	 * 
	 * @param key A <CODE>PdfName</CODE>
	 ...
	 * associated with the <CODE>PdfName</CODE> given is retrieved If it is a
