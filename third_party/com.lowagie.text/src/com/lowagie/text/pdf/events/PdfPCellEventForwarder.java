...
/**
 * If you want to add more than one event to a cell, you have to construct a PdfPCellEventForwarder,
 * add the different events to this object and add the forwarder to the PdfPCell.
 */
