 ...
 * automatic and manual error levels, raw codeword input, codeword size optimization and bitmap
 * inversion. The output can be a CCITT G4 <CODE>Image</CODE> or a raw bitmap.
 * 
...
public class BarcodePDF417 {
	...
	/**
	 * The size will be at least <CODE>codeColumns</CODE> with a variable number of
	 * <CODE>codeRows</CODE>.
	 */
	...
	/**
	 * No <CODE>text</CODE> interpretation is done and the content of <CODE>codewords</CODE> is used
	 * directly.
	 */
	public static final int	PDF417_USE_RAW_CODEWORDS	= 64;
	/**
	 * Inverts the output bits of the raw bitmap that is normally bit one for black. It has only
	 * effect for the raw bitmap.
	 */
	...
	/**
	 * Gets the raw image bits of the barcode. The image will have to be scaled in the Y direction
	 * by <CODE>yHeight</CODE>.
	 * 
	...
	/**
	 * Gets the number of Y pixels of <CODE>outBits</CODE>. It is also the number of rows in the
	 * barcode.
	 * 
	...
	/**
	 * Sets the number of barcode data columns. This number may be changed to keep the barcode
	 * valid.
	 * 
	...
	/**
	 * Gets the codeword array. This array is always 928 elements long. It can be written to if the
	 * option <CODE>PDF417_USE_RAW_CODEWORDS</CODE> is set.
	 * 
	...
	/**
	 * Gets the error level correction used for the barcode. It may different from the previously
	 * set value.
	 * 
	...
	/**
	 * Sets the text that will form the barcode. This text is converted to bytes using the encoding
	 * Cp437.
	 * 
	...
	/**
	 * Sets the options to generate the barcode. This can be all the <CODE>PDF417_*</CODE>
	 * constants.
	 * 
	...
	/**
	 * Sets the barcode aspect ratio. A ratio or 0.5 will make the barcode width twice as large as
	 * the height.
	 * 
