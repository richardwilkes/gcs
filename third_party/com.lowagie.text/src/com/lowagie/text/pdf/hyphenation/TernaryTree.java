 ...
 * <p>
 * A ternary search tree is a hybrid between a binary tree and a digital search tree (trie). Keys
 ...
 * </p>
 * <p>
 * The main purpose of this java port is to serve as a base for implementing TeX's hyphenation
 ...
 * </p>
 * <p>
 * All said, this is a map with strings as keys and char as value. Pretty limited!. It can be
 * extended to a general map by using the string representation of an object and using the char
 * value as an index to an array that contains the object values.
 * </p>
 *
...
public class TernaryTree implements Cloneable, Serializable {
	 ...
	 * somehow Knuth's pascal code made me forget we now have a portable language with virtual
	 * memory management and automatic garbage collection! And now is kind of late, furthermore, if
	...
	/**
	 * Pointer to low branch and to rest of the key when it is stored directly in this node, we
	 * don't have unions in java!
	 */
	protected char[]			lo;
	...
	protected int				length;										    // number of items
																			    // in tree

	protected static final int	BLOCK_SIZE			= 2048;					    // allocation size
																			    // for arrays
	 ...
	 * They are decompressed as needed when another key with same prefix is inserted. This saves a
	 * lot of space, specially for long keys.
	 */
