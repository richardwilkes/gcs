...
public class PdfContentParser {
	 ...
	 * having the command itself as the last element. The returned array will be empty if the end of
	 * content was reached.
	 * 
	 ...
	 * 
	 * @return <CODE>true</CODE> if a token was read, <CODE>false</CODE> if the end of content was
	 *         reached
	 * @throws IOException on error
	 */
