...
public class DefaultFontMapper implements FontMapper {
	 ...
	 * 
	 * @param allNames the returned value of calling
	...
	/**
	 * Inserts all the fonts recognized by iText in the <CODE>directory</CODE> into the map. The
	 * encoding will be <CODE>BaseFont.CP1252</CODE> but can be changed later.
	 * 
