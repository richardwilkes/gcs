...
public class PdfNameTree {
	 ...
	 *            <CODE>PdfObject</CODE>. Note that although the keys are strings only the lower
	 *            byte is used and no check is made for chars with the same lower byte and different
	 *            upper byte. This will generate a wrong tree name.
	 * @param writer the writer
	 * @throws IOException on error
	 * @return the dictionary with the name tree. This dictionary is the one generally pointed to by
	 *         the key /Dests, for example
	 */
