...
public class BidiLine {
	...
	// protected ArabicShaping arabic = new ArabicShaping(ArabicShaping.LETTERS_SHAPE |
	...
	static {
		...
		mirrorChars.put(0x22F4, 0x22FC); // SMALL ELEMENT OF WITH VERTICAL BAR AT END OF HORIZONTAL
										 // STROKE
		...
		mirrorChars.put(0x22FC, 0x22F4); // SMALL CONTAINS WITH VERTICAL BAR AT END OF HORIZONTAL
										 // STROKE
		...
		mirrorChars.put(0x2A93, 0x2A94); // LESS-THAN ABOVE SLANTED EQUAL ABOVE GREATER-THAN ABOVE
										 // SLANTED EQUAL
		mirrorChars.put(0x2A94, 0x2A93); // GREATER-THAN ABOVE SLANTED EQUAL ABOVE LESS-THAN ABOVE
										 // SLANTED EQUAL
