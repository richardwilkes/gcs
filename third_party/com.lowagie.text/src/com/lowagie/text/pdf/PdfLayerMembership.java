...
/**
 * Content typically belongs to a single optional content group, and is visible when the group is
 * <B>ON</B> and invisible when it is <B>OFF</B>. To express more complex visibility policies,
 * content should not declare itself to belong to an optional content group directly, but rather to
...
public class PdfLayerMembership extends PdfDictionary implements PdfOCG {
	...
	/**
	 * Sets the visibility policy for content belonging to this membership dictionary. Possible
	 * values are ALLON, ANYON, ANYOFF and ALLOFF. The default value is ANYON.
	 * 
