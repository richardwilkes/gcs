...
public class PdfGraphics2D extends Graphics2D {
	...
	protected boolean						underline;																					          // indicates
																																		          // if
																																		          // the
																																		          // font
																																		          // style
	...
	public static final int					AFM_DIVISOR			= 1000;																	 // used
																																		 // to
																																		 // calculate
																																		 // coordinates
	...
	public void drawString(String s, float x, float y) {
		...
		setFillPaint();
		if (onlyShapes) {
			drawGlyphVector(font.layoutGlyphVector(getFontRenderContext(), s.toCharArray(), 0, s.length(), java.awt.Font.LAYOUT_LEFT_TO_RIGHT), x, y);
			...
			// Do nothing if the BaseFont is already bold. This test is not foolproof but it will
	...
	public Graphics create() {
		...
		kids.add(Integer.valueOf(cb.getInternalBuffer().size()));
		kids.add(g2);
		return g2;
	}
