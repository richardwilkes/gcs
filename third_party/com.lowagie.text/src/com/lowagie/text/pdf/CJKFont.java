...
class CJKFont extends BaseFont {
	...
	/**
	 * You can't get the FontStream of a CJK font (CJK fonts are never embedded), so this method
	 * always returns null.
	 * 
	 * @return null
	 * @since 2.1.3
	 ...
	 * @return <CODE>true</CODE> if the advance was set, <CODE>false</CODE> otherwise. Will always
