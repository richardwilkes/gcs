...
/**
 * Reads gif images of all types. All the images in a gif are read in the constructors and can be
 * retrieved with other methods.
 * 
...
public class GifImage {
	...
	protected int				bgIndex;							          // background color
																	          // index
	...
	protected int				lctSize;							          // local color table
																	          // size
	...
	protected int				dispose			= 0;				   // 0=no action; 1=leave in
																	   // place; 2=restore to bg;
																	   // 3=restore to prev
	protected boolean			transparency	= false;			   // use transparent color
	protected int				delay			= 0;				        // delay in milliseconds
	protected int				transIndex;							       // transparent color
																	       // index
	...
	/**
	 * Gets the logical screen. The images may be smaller and placed in some position in this screen
	 * to playback some animation. No image will be be bigger that this.
	 * 
	...
	protected boolean decodeImageData() throws IOException {
		...
		int available, clear, code_mask, code_size, end_of_information, in_code, old_code, bits,
						code, count, i, datum, data_size, first, top, bi;
