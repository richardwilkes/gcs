...
public class Type3Font extends BaseFont {
	 ...
	 * @param chars an array of chars corresponding to the glyphs used (not used, present for
	 *            compatibility only)
	 * @param colorized if <CODE>true</CODE> the font may specify color, if <CODE>false</CODE> no
	 *            color commands are allowed and only images as masks can be used
	 */
	...
	/**
	 * Creates a Type3 font. This implementation assumes that the /FontMatrix is [0.001 0 0 0.001 0
	 * 0] or a 1000-unit glyph coordinate system.
	 * <p>
	 * An example:
	 * <p>
	 * 
	 ...
	 * @param llx the X lower left corner of the glyph bounding box. If the <CODE>colorize</CODE>
	 *            option is <CODE>true</CODE> the value is ignored
	 * @param lly the Y lower left corner of the glyph bounding box. If the <CODE>colorize</CODE>
	 *            option is <CODE>true</CODE> the value is ignored
	 * @param urx the X upper right corner of the glyph bounding box. If the <CODE>colorize</CODE>
	 *            option is <CODE>true</CODE> the value is ignored
	 * @param ury the Y upper right corner of the glyph bounding box. If the <CODE>colorize</CODE>
	 *            option is <CODE>true</CODE> the value is ignored
