...
public class BarcodeDatamatrix {
	 ...
	 *         <CODE>DM_ERROR_TEXT_TOO_BIG</CODE> - the text is too big for the symbology
	 *         capabilities.<br>
	 *         <CODE>DM_ERROR_INVALID_SQUARE</CODE> - the dimensions given for the symbol are
	 *         illegal.<br>
	...
	/**
	 * Gets the generated image. The image is represented as a stream of bytes, each byte
	 * representing 8 pixels, 0 for white and 1 for black, with the high-order bit of each byte
	 * first. Each row is aligned at byte boundaries. The dimensions of the image are defined by
	 * height and width plus 2 * ws.
	 * 
	...
	/**
	 * Sets the height of the barcode. If the height is zero it will be calculated. This height
	 * doesn't include the whitespace border, if any.
	 * <p>
	...
	/**
	 * Sets the width of the barcode. If the width is zero it will be calculated. This width doesn't
	 * include the whitespace border, if any.
	 * <p>
	 * The allowed dimensions are (height, width):
	 * <p>
	 * 10, 10<br>
	 ...
	 * <CODE>DM_RAW</CODE> - no encodation. The bytes provided are already encoded and will be added
	 * directly to the barcode, using padding if needed. It assumes that the encodation state is
	 * left at ASCII after the last byte.<br>
	 * <p>
	 * One of:<br>
	 ...
	 * m6 - macro 6<br>
	 * f - FNC1<br>
	 * saabbccccc - Structured Append, aa symbol position (1-16), bb total number of symbols (2-16),
	 * ccccc file identification (0-64515)<br>
	 * p - Reader programming<br>
	 * . - extension terminator
	 * <p>
	 * Example for a structured append, symbol 2 of 6, with FNC1 and ECI 000005. The actual text is
	 * "Hello".
	 * <p>
