...
public class EntitiesToUnicode {
	...
	static {
		map.put("nbsp", Character.valueOf('\u00a0')); // no-break space = non-breaking space, U+00A0
														 // ISOnum
		...
		map.put("brvbar", Character.valueOf('\u00a6')); // broken bar = broken vertical bar, U+00A6
														 // ISOnum
		...
		map.put("laquo", Character.valueOf('\u00ab')); // left-pointing double angle quotation mark
														 // = left pointing guillemet, U+00AB ISOnum
		map.put("not", Character.valueOf('\u00ac')); // not sign, U+00AC ISOnum
		map.put("shy", Character.valueOf('\u00ad')); // soft hyphen = discretionary hyphen, U+00AD
													 // ISOnum
		map.put("reg", Character.valueOf('\u00ae')); // registered sign = registered trade mark
													 // sign, U+00AE ISOnum
		map.put("macr", Character.valueOf('\u00af')); // macron = spacing macron = overline = APL
														 // overbar, U+00AF ISOdia
		map.put("deg", Character.valueOf('\u00b0')); // degree sign, U+00B0 ISOnum
		map.put("plusmn", Character.valueOf('\u00b1')); // plus-minus sign = plus-or-minus sign,
														 // U+00B1 ISOnum
		map.put("sup2", Character.valueOf('\u00b2')); // superscript two = superscript digit two =
														 // squared, U+00B2 ISOnum
		map.put("sup3", Character.valueOf('\u00b3')); // superscript three = superscript digit three
														 // = cubed, U+00B3 ISOnum
		map.put("acute", Character.valueOf('\u00b4')); // acute accent = spacing acute, U+00B4
														 // ISOdia
		map.put("micro", Character.valueOf('\u00b5')); // micro sign, U+00B5 ISOnum
		map.put("para", Character.valueOf('\u00b6')); // pilcrow sign = paragraph sign, U+00B6
														 // ISOnum
		map.put("middot", Character.valueOf('\u00b7')); // middle dot = Georgian comma = Greek
														 // middle dot, U+00B7 ISOnum
		map.put("cedil", Character.valueOf('\u00b8')); // cedilla = spacing cedilla, U+00B8 ISOdia
		map.put("sup1", Character.valueOf('\u00b9')); // superscript one = superscript digit one,
														 // U+00B9 ISOnum
		map.put("ordm", Character.valueOf('\u00ba')); // masculine ordinal indicator, U+00BA ISOnum
		map.put("raquo", Character.valueOf('\u00bb')); // right-pointing double angle quotation mark
														 // = right pointing guillemet, U+00BB
														 // ISOnum
		map.put("frac14", Character.valueOf('\u00bc')); // vulgar fraction one quarter = fraction
														 // one quarter, U+00BC ISOnum
		map.put("frac12", Character.valueOf('\u00bd')); // vulgar fraction one half = fraction one
														 // half, U+00BD ISOnum
		map.put("frac34", Character.valueOf('\u00be')); // vulgar fraction three quarters = fraction
														 // three quarters, U+00BE ISOnum
		map.put("iquest", Character.valueOf('\u00bf')); // inverted question mark = turned question
														 // mark, U+00BF ISOnum
		map.put("Agrave", Character.valueOf('\u00c0')); // latin capital letter A with grave = latin
														 // capital letter A grave, U+00C0 ISOlat1
		map.put("Aacute", Character.valueOf('\u00c1')); // latin capital letter A with acute, U+00C1
														 // ISOlat1
		map.put("Acirc", Character.valueOf('\u00c2')); // latin capital letter A with circumflex,
														 // U+00C2 ISOlat1
		map.put("Atilde", Character.valueOf('\u00c3')); // latin capital letter A with tilde, U+00C3
														 // ISOlat1
		map.put("Auml", Character.valueOf('\u00c4')); // latin capital letter A with diaeresis,
														 // U+00C4 ISOlat1
		map.put("Aring", Character.valueOf('\u00c5')); // latin capital letter A with ring above =
														 // latin capital letter A ring, U+00C5
														 // ISOlat1
		map.put("AElig", Character.valueOf('\u00c6')); // latin capital letter AE = latin capital
														 // ligature AE, U+00C6 ISOlat1
		map.put("Ccedil", Character.valueOf('\u00c7')); // latin capital letter C with cedilla,
														 // U+00C7 ISOlat1
		map.put("Egrave", Character.valueOf('\u00c8')); // latin capital letter E with grave, U+00C8
														 // ISOlat1
		map.put("Eacute", Character.valueOf('\u00c9')); // latin capital letter E with acute, U+00C9
														 // ISOlat1
		map.put("Ecirc", Character.valueOf('\u00ca')); // latin capital letter E with circumflex,
														 // U+00CA ISOlat1
		map.put("Euml", Character.valueOf('\u00cb')); // latin capital letter E with diaeresis,
														 // U+00CB ISOlat1
		map.put("Igrave", Character.valueOf('\u00cc')); // latin capital letter I with grave, U+00CC
														 // ISOlat1
		map.put("Iacute", Character.valueOf('\u00cd')); // latin capital letter I with acute, U+00CD
														 // ISOlat1
		map.put("Icirc", Character.valueOf('\u00ce')); // latin capital letter I with circumflex,
														 // U+00CE ISOlat1
		map.put("Iuml", Character.valueOf('\u00cf')); // latin capital letter I with diaeresis,
														 // U+00CF ISOlat1
		map.put("ETH", Character.valueOf('\u00d0')); // latin capital letter ETH, U+00D0 ISOlat1
		map.put("Ntilde", Character.valueOf('\u00d1')); // latin capital letter N with tilde, U+00D1
														 // ISOlat1
		map.put("Ograve", Character.valueOf('\u00d2')); // latin capital letter O with grave, U+00D2
														 // ISOlat1
		map.put("Oacute", Character.valueOf('\u00d3')); // latin capital letter O with acute, U+00D3
														 // ISOlat1
		map.put("Ocirc", Character.valueOf('\u00d4')); // latin capital letter O with circumflex,
														 // U+00D4 ISOlat1
		map.put("Otilde", Character.valueOf('\u00d5')); // latin capital letter O with tilde, U+00D5
														 // ISOlat1
		map.put("Ouml", Character.valueOf('\u00d6')); // latin capital letter O with diaeresis,
														 // U+00D6 ISOlat1
		map.put("times", Character.valueOf('\u00d7')); // multiplication sign, U+00D7 ISOnum
		map.put("Oslash", Character.valueOf('\u00d8')); // latin capital letter O with stroke =
														 // latin capital letter O slash, U+00D8
														 // ISOlat1
		map.put("Ugrave", Character.valueOf('\u00d9')); // latin capital letter U with grave, U+00D9
														 // ISOlat1
		map.put("Uacute", Character.valueOf('\u00da')); // latin capital letter U with acute, U+00DA
														 // ISOlat1
		map.put("Ucirc", Character.valueOf('\u00db')); // latin capital letter U with circumflex,
														 // U+00DB ISOlat1
		map.put("Uuml", Character.valueOf('\u00dc')); // latin capital letter U with diaeresis,
														 // U+00DC ISOlat1
		map.put("Yacute", Character.valueOf('\u00dd')); // latin capital letter Y with acute, U+00DD
														 // ISOlat1
		map.put("THORN", Character.valueOf('\u00de')); // latin capital letter THORN, U+00DE ISOlat1
		map.put("szlig", Character.valueOf('\u00df')); // latin small letter sharp s = ess-zed,
														 // U+00DF ISOlat1
		map.put("agrave", Character.valueOf('\u00e0')); // latin small letter a with grave = latin
														 // small letter a grave, U+00E0 ISOlat1
		map.put("aacute", Character.valueOf('\u00e1')); // latin small letter a with acute, U+00E1
														 // ISOlat1
		map.put("acirc", Character.valueOf('\u00e2')); // latin small letter a with circumflex,
														 // U+00E2 ISOlat1
		map.put("atilde", Character.valueOf('\u00e3')); // latin small letter a with tilde, U+00E3
														 // ISOlat1
		map.put("auml", Character.valueOf('\u00e4')); // latin small letter a with diaeresis, U+00E4
														 // ISOlat1
		map.put("aring", Character.valueOf('\u00e5')); // latin small letter a with ring above =
														 // latin small letter a ring, U+00E5
														 // ISOlat1
		map.put("aelig", Character.valueOf('\u00e6')); // latin small letter ae = latin small
														 // ligature ae, U+00E6 ISOlat1
		map.put("ccedil", Character.valueOf('\u00e7')); // latin small letter c with cedilla, U+00E7
														 // ISOlat1
		map.put("egrave", Character.valueOf('\u00e8')); // latin small letter e with grave, U+00E8
														 // ISOlat1
		map.put("eacute", Character.valueOf('\u00e9')); // latin small letter e with acute, U+00E9
														 // ISOlat1
		map.put("ecirc", Character.valueOf('\u00ea')); // latin small letter e with circumflex,
														 // U+00EA ISOlat1
		map.put("euml", Character.valueOf('\u00eb')); // latin small letter e with diaeresis, U+00EB
														 // ISOlat1
		map.put("igrave", Character.valueOf('\u00ec')); // latin small letter i with grave, U+00EC
														 // ISOlat1
		map.put("iacute", Character.valueOf('\u00ed')); // latin small letter i with acute, U+00ED
														 // ISOlat1
		map.put("icirc", Character.valueOf('\u00ee')); // latin small letter i with circumflex,
														 // U+00EE ISOlat1
		map.put("iuml", Character.valueOf('\u00ef')); // latin small letter i with diaeresis, U+00EF
														 // ISOlat1
		map.put("eth", Character.valueOf('\u00f0')); // latin small letter eth, U+00F0 ISOlat1
		map.put("ntilde", Character.valueOf('\u00f1')); // latin small letter n with tilde, U+00F1
														 // ISOlat1
		map.put("ograve", Character.valueOf('\u00f2')); // latin small letter o with grave, U+00F2
														 // ISOlat1
		map.put("oacute", Character.valueOf('\u00f3')); // latin small letter o with acute, U+00F3
														 // ISOlat1
		map.put("ocirc", Character.valueOf('\u00f4')); // latin small letter o with circumflex,
														 // U+00F4 ISOlat1
		map.put("otilde", Character.valueOf('\u00f5')); // latin small letter o with tilde, U+00F5
														 // ISOlat1
		map.put("ouml", Character.valueOf('\u00f6')); // latin small letter o with diaeresis, U+00F6
														 // ISOlat1
		map.put("divide", Character.valueOf('\u00f7')); // division sign, U+00F7 ISOnum
		map.put("oslash", Character.valueOf('\u00f8')); // latin small letter o with stroke, = latin
														 // small letter o slash, U+00F8 ISOlat1
		map.put("ugrave", Character.valueOf('\u00f9')); // latin small letter u with grave, U+00F9
														 // ISOlat1
		map.put("uacute", Character.valueOf('\u00fa')); // latin small letter u with acute, U+00FA
														 // ISOlat1
		map.put("ucirc", Character.valueOf('\u00fb')); // latin small letter u with circumflex,
														 // U+00FB ISOlat1
		map.put("uuml", Character.valueOf('\u00fc')); // latin small letter u with diaeresis, U+00FC
														 // ISOlat1
		map.put("yacute", Character.valueOf('\u00fd')); // latin small letter y with acute, U+00FD
														 // ISOlat1
		map.put("thorn", Character.valueOf('\u00fe')); // latin small letter thorn, U+00FE ISOlat1
		map.put("yuml", Character.valueOf('\u00ff')); // latin small letter y with diaeresis, U+00FF
														 // ISOlat1
		// Latin Extended-B
		map.put("fnof", Character.valueOf('\u0192')); // latin small f with hook = function =
		...
		map.put("Lambda", Character.valueOf('\u039b')); // greek capital letter lambda, U+039B
														 // ISOgrk3
		...
		map.put("Upsilon", Character.valueOf('\u03a5')); // greek capital letter upsilon, U+03A5
														 // ISOgrk3
		...
		map.put("epsilon", Character.valueOf('\u03b5')); // greek small letter epsilon, U+03B5
														 // ISOgrk3
		...
		map.put("sigmaf", Character.valueOf('\u03c2')); // greek small letter final sigma, U+03C2
														 // ISOgrk3
		...
		map.put("upsilon", Character.valueOf('\u03c5')); // greek small letter upsilon, U+03C5
														 // ISOgrk3
		...
		map.put("thetasym", Character.valueOf('\u03d1')); // greek small letter theta symbol, U+03D1
															 // NEW
		...
		map.put("hellip", Character.valueOf('\u2026')); // horizontal ellipsis = three dot leader,
														 // U+2026 ISOpub
		map.put("prime", Character.valueOf('\u2032')); // prime = minutes = feet, U+2032 ISOtech
		map.put("Prime", Character.valueOf('\u2033')); // double prime = seconds = inches, U+2033
														 // ISOtech
		...
		// Letterlike Symbols
		map.put("weierp", Character.valueOf('\u2118')); // script capital P = power set =
														 // Weierstrass p, U+2118 ISOamso
		map.put("image", Character.valueOf('\u2111')); // blackletter capital I = imaginary part,
														 // U+2111 ISOamso
		map.put("real", Character.valueOf('\u211c')); // blackletter capital R = real part symbol,
														 // U+211C ISOamso
		map.put("trade", Character.valueOf('\u2122')); // trade mark sign, U+2122 ISOnum
		map.put("alefsym", Character.valueOf('\u2135')); // alef symbol = first transfinite
														 // cardinal, U+2135 NEW
		...
		map.put("crarr", Character.valueOf('\u21b5')); // downwards arrow with corner leftwards =
		...
		map.put("empty", Character.valueOf('\u2205')); // empty set = null set = diameter, U+2205
														 // ISOamso
		map.put("nabla", Character.valueOf('\u2207')); // nabla = backward difference, U+2207
														 // ISOtech
		...
		map.put("prod", Character.valueOf('\u220f')); // n-ary product = product sign, U+220F
														 // ISOamsb
		...
		map.put("sim", Character.valueOf('\u223c')); // tilde operator = varies with = similar to,
													 // U+223C ISOtech
		// tilde operator is NOT the same character as the tilde, U+007E,
		// although the same glyph might be used to represent both
		map.put("cong", Character.valueOf('\u2245')); // approximately equal to, U+2245 ISOtech
		map.put("asymp", Character.valueOf('\u2248')); // almost equal to = asymptotic to, U+2248
														 // ISOamsr
		...
		map.put("otimes", Character.valueOf('\u2297')); // circled times = vector product, U+2297
														 // ISOamsb
		map.put("perp", Character.valueOf('\u22a5')); // up tack = orthogonal to = perpendicular,
														 // U+22A5 ISOtech
		...
		map.put("lfloor", Character.valueOf('\u230a')); // left floor = apl downstile, U+230A
														 // ISOamsc
		map.put("rfloor", Character.valueOf('\u230b')); // right floor, U+230B ISOamsc
		map.put("lang", Character.valueOf('\u2329')); // left-pointing angle bracket = bra, U+2329
														 // ISOtech
		// lang is NOT the same character as U+003C 'less than'
		// or U+2039 'single left-pointing angle quotation mark'
		map.put("rang", Character.valueOf('\u232a')); // right-pointing angle bracket = ket, U+232A
														 // ISOtech
		...
		map.put("hearts", Character.valueOf('\u2665')); // black heart suit = valentine, U+2665
														 // ISOpub
		...
		map.put("Scaron", Character.valueOf('\u0160')); // latin capital letter S with caron, U+0160
														 // ISOlat2
		map.put("scaron", Character.valueOf('\u0161')); // latin small letter s with caron, U+0161
														 // ISOlat2
		map.put("Yuml", Character.valueOf('\u0178')); // latin capital letter Y with diaeresis,
														 // U+0178 ISOlat2
		// Spacing Modifier Letters
		map.put("circ", Character.valueOf('\u02c6')); // modifier letter circumflex accent, U+02C6
														 // ISOpub
		...
		map.put("lsaquo", Character.valueOf('\u2039')); // single left-pointing angle quotation
														 // mark, U+2039 ISO proposed
		// lsaquo is proposed but not yet ISO standardized
		map.put("rsaquo", Character.valueOf('\u203a')); // single right-pointing angle quotation
	...
	/**
	 * Translates a String with entities (&...;) to a String without entities, replacing the entity
