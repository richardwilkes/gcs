...
public class IanaEncodings {
	...
	static {
		...
		map.put("ISO-8859-8-I", "ISO8859_8"); // added since this encoding only differs w.r.t.
												 // presentation
	...
	/**
	 * Gets the java encoding from the IANA encoding. If the encoding cannot be found it returns the
	 * input.
	 * 
