 ...
 * <P>
 * A <CODE>Phrase</CODE> has a main <CODE>Font</CODE>, but some chunks within the phrase can have a
 * <CODE>Font</CODE> that differs from the main <CODE>Font</CODE>. All the <CODE>Chunk</CODE>s in a
 * <CODE>Phrase</CODE> have the same <CODE>leading</CODE>.
 * <P>
 * Example: <BLOCKQUOTE>
 * 
 * <PRE>
...
public class Phrase extends ArrayList implements TextElementArray {
	...
	/**
	 * Constructs a <CODE>Phrase</CODE> with a certain <CODE>String</CODE> and a certain
	 * <CODE>Font</CODE>.
	 *
	 * @param string a <CODE>String</CODE>
	...
	/**
	 * Constructs a <CODE>Phrase</CODE> with a certain leading, a certain <CODE>String</CODE> and a
	...
	/**
	 * Adds a <CODE>Chunk</CODE>, an <CODE>Anchor</CODE> or another <CODE>Phrase</CODE> to this
	 * <CODE>Phrase</CODE>.
	 *
	...
	public void add(int index, Object o) {
		...
		try {
			...
			} else if (element.type() == Element.PHRASE || element.type() == Element.ANCHOR || element.type() == Element.ANNOTATION || element.type() == Element.TABLE || // line
																																											 // added
																																											 // by
																																											 // David
																																											 // Freels
	...
	/**
	 * Adds a <CODE>Chunk</CODE>, <CODE>Anchor</CODE> or another <CODE>Phrase</CODE> to this
	 * <CODE>Phrase</CODE>.
	 *
	 * @param o an object of type <CODE>Chunk</CODE>, <CODE>Anchor</CODE> or <CODE>Phrase</CODE>
	 * @return a boolean
	 ...
	 *
	 * @param collection a collection of <CODE>Chunk</CODE>s, <CODE>Anchor</CODE>s and
	 *            <CODE>Phrase</CODE>s.
	 ...
	 * Adds a Chunk.
	 * <p>
	 * This method is a hack to solve a problem I had with phrases that were split between chunks in
	 * the wrong place.
	 * 
	...
	/**
	 * Returns the content as a String object. This method differs from toString because toString
	 * will return an ArrayList with the toString value of the Chunks in this Phrase.
	 */
	 ...
	 *
	 * @return <CODE>false</CODE> if the <CODE>Phrase</CODE> contains more than one or more
	 *         non-empty<CODE>Chunk</CODE>s.
	 */
	@Override
