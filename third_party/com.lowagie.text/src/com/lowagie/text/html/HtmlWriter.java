 ...
 * <P>
 * An <CODE>HtmlWriter</CODE> can be added as a <CODE>DocListener</CODE> to a certain
 * <CODE>Document</CODE> by getting an instance. Every <CODE>Element</CODE> added to the original
 * <CODE>Document</CODE> will be written to the <CODE>OutputStream</CODE> of this
 * <CODE>HtmlWriter</CODE>.
 * <P>
 * Example: <BLOCKQUOTE>
 * 
 * <PRE>
...
public class HtmlWriter extends DocWriter {
	...
	/**
	 * Writes a JavaScript section or, if the markup attribute HtmlTags.URL is set, a JavaScript
	 ...
	 * <P>
	 * This is especially useful if you add images using a file, rather than an URL. In PDF there is
	 * no problem, since the images are added inline, but in HTML it is sometimes necessary to use a
	 * relative path or a special path to some images directory.
	 *
