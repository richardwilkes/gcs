...
/**
 * Rectangle that can be used for Cells. This Rectangle is padded and knows how to draw itself in a
 * PdfPTable or PdfPcellEvent.
 */
...
public class SimpleCell extends Rectangle implements PdfPCellEvent, TextElementArray {
	...
	/**
	 * A CellAttributes object is always constructed without any dimensions. Dimensions are defined
	 * after creation.
	 * 
