...
func (d *Dockable) Setup(ws *Workspace, dc *unison.DockContainer, addToStartToolbar, addToEndToolbar, initContent func(*unison.Panel)) {
...
func (d *Dockable) MarkModified(_ unison.Paneler) {
	d.Modified()
