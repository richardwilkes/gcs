...
func initWeaponEditor(e *editor[*gurps.Weapon, *gurps.Weapon], content *unison.Panel) func() {
	...
	if e.editorData.Type == wpn.Ranged {
		...
		content.AddChild(unison.NewPanel())
		addCheckBox(content, i18n.Text("Mounted"), &e.editorData.Strength.Mounted)
		content.AddChild(unison.NewPanel())
		addCheckBox(content, i18n.Text("Uses a musket rest"), &e.editorData.Strength.MusketRest)
	}
	content.AddChild(unison.NewPanel())
	...
	case wpn.Melee:
		...
		content.AddChild(unison.NewPanel())
		addCheckBox(content, i18n.Text("Close Combat"), &e.editorData.Reach.CloseCombat)
		content.AddChild(unison.NewPanel())
		addCheckBox(content, i18n.Text("Reach Change Requires Ready"), &e.editorData.Reach.ChangeRequiresReady)
		parryCheckBox := addInvertedCheckBox(content, i18n.Text("Parry Modifier"), &e.editorData.Parry.No)
		parryCheckBox.SetLayoutData(&unison.FlexLayoutData{
			HAlign: align.End,
			VAlign: align.Middle,
		})
		parryField := addDecimalFieldWithSign(content, nil, "", i18n.Text("Parry Modifier"), "", &e.editorData.Parry.Modifier, -fxp.Max, fxp.Max)
		parryCheckBox.OnSet = func() {
			parryField.SetEnabled(parryCheckBox.State == check.On)
		}
		parryCheckBox.OnSet()
		content.AddChild(unison.NewPanel())
		addCheckBox(content, i18n.Text("Fencing"), &e.editorData.Parry.Fencing)
		content.AddChild(unison.NewPanel())
		addCheckBox(content, i18n.Text("Unbalanced"), &e.editorData.Parry.Unbalanced)
		blockCheckBox := addInvertedCheckBox(content, i18n.Text("Block Modifier"), &e.editorData.Block.No)
		blockCheckBox.SetLayoutData(&unison.FlexLayoutData{
			HAlign: align.End,
			VAlign: align.Middle,
		})
		blockField := addDecimalFieldWithSign(content, nil, "", i18n.Text("Block Modifier"), "", &e.editorData.Block.Modifier, -fxp.Max, fxp.Max)
	...
	case wpn.Ranged:
		...
		content.AddChild(unison.NewPanel())
		addCheckBox(content, i18n.Text("Jet"), &e.editorData.RateOfFire.Jet)
		addRateOfFireBlock(content, &e.editorData.RateOfFire.Mode1, 1)
		addRateOfFireBlock(content, &e.editorData.RateOfFire.Mode2, 2)
		addLabelAndDecimalField(content, nil, "", i18n.Text("Half-Damage Range"), "", &e.editorData.Range.HalfDamageRange, 0, fxp.Max)
		addLabelAndDecimalField(content, nil, "", i18n.Text("Minimum Range"), "", &e.editorData.Range.MinRange, 0, fxp.Max)
		addLabelAndDecimalField(content, nil, "", i18n.Text("Maximum Range"), "", &e.editorData.Range.MaxRange, 0, fxp.Max)
		content.AddChild(unison.NewPanel())
		addCheckBox(content, i18n.Text("Muscle Powered"), &e.editorData.Range.MusclePowered)
		content.AddChild(unison.NewPanel())
		addCheckBox(content, i18n.Text("Range in Miles"), &e.editorData.Range.RangeInMiles)
		addLabelAndDecimalField(content, nil, "", i18n.Text("Shot Recoil"), "", &e.editorData.Recoil.ShotRecoil, 0, fxp.Max)
		addLabelAndDecimalField(content, nil, "", i18n.Text("Slug Recoil"), "", &e.editorData.Recoil.SlugRecoil, 0, fxp.Max)
		addLabelAndDecimalField(content, nil, "", i18n.Text("Shots"), "", &e.editorData.Shots.NonChamberShots, 0, fxp.Max)
		addLabelAndDecimalField(content, nil, "", i18n.Text("Chamber Shots"), "", &e.editorData.Shots.ChamberShots, 0, fxp.Max)
		addLabelAndDecimalField(content, nil, "", i18n.Text("Shot Duration"), "", &e.editorData.Shots.ShotDuration, 0, fxp.Max)
		addLabelAndDecimalField(content, nil, "", i18n.Text("Reload Time"), "", &e.editorData.Shots.ChamberShots, 0, fxp.Max)
		content.AddChild(unison.NewPanel())
		addCheckBox(content, i18n.Text("Reload Time is Per Shot"), &e.editorData.Shots.ReloadTimeIsPerShot)
		content.AddChild(unison.NewPanel())
		addCheckBox(content, i18n.Text("Thrown Weapon"), &e.editorData.Shots.Thrown)
		addLabelAndDecimalField(content, nil, "", i18n.Text("Normal Bulk"), "", &e.editorData.Bulk.NormalBulk, -fxp.Max, 0)
		giant := i18n.Text("Giant Bulk")
		wrapper := addFlowWrapper(content, giant, 2)
		addDecimalField(wrapper, nil, "", giant, "", &e.editorData.Bulk.GiantBulk, -fxp.Max, 0)
		wrapper.AddChild(NewFieldTrailingLabel(i18n.Text("(only needed if different from normal bulk)"), true))
		content.AddChild(unison.NewPanel())
		addCheckBox(content, i18n.Text("Retracting Stock"), &e.editorData.Bulk.RetractingStock)
	default:
	}
