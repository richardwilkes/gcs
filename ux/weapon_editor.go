...
func initWeaponEditor(e *editor[*gurps.Weapon, *gurps.Weapon], content *unison.Panel) func() {
	...
	case gurps.RangedWeaponType:
		...
		addLabelAndDecimalField(content, nil, "", i18n.Text("Shot Recoil"), "", &e.editorData.RecoilParts.ShotRecoil, 0, fxp.Max)
		addLabelAndDecimalField(content, nil, "", i18n.Text("Slug Recoil"), "", &e.editorData.RecoilParts.SlugRecoil, 0, fxp.Max)
		addLabelAndDecimalField(content, nil, "", i18n.Text("Shots"), "", &e.editorData.ShotsParts.NonChamberShots, 0, fxp.Max)
		addLabelAndDecimalField(content, nil, "", i18n.Text("Chamber Shots"), "", &e.editorData.ShotsParts.ChamberShots, 0, fxp.Max)
		addLabelAndDecimalField(content, nil, "", i18n.Text("Shot Duration"), "", &e.editorData.ShotsParts.ShotDuration, 0, fxp.Max)
		addLabelAndDecimalField(content, nil, "", i18n.Text("Reload Time"), "", &e.editorData.ShotsParts.ChamberShots, 0, fxp.Max)
		content.AddChild(unison.NewPanel())
