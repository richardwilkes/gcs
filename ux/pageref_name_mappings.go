...
var PageRefKeyNameMappings = map[string]string{
	...
	"ACTA1:":  "Action Adventure 1: Templar's Gold",
	"AD":      "Adaptations",
	"AS":      "Aliens: Sparrials",
	...
	"DF21:":   "Dungeon Fantasy 21: Megadungeons",
	"DF22:":   "Dungeon Fantasy 22: Gates",
	"DF23:":   "Dungeon Fantasy 23: Twists",
	"DF24:":   "Dungeon Fantasy 24: Finer Points",
	...
	"DFA4:":   "Dungeon Fantasy Adventure 4: Two-Page Dungeons",
	"DFC":     "Dungeon Fantasy Collected",
	"DFCG":    "Dungeon Fantasy Career Guide 2020 Edition",
	"DFDB":    "Dungeon Fantasy Denizens: Barbarians",
	"DFDS":    "Dungeon Fantasy Denizens: Swashbucklers",
	"DFDT":    "Dungeon Fantasy Denizens: Thieves",
	...
	"DFE4:":   "Dungeon Fantasy Encounters 4: Ring Fort",
	...
	"DFRC3:":  "Dungeon Fantasy RPG: Companion 3",
	...
	"DTG":     "Delvers To Grow",
	"DW":      "Discworld RPG",
	"EHHC":    "Encounters: The Harrowed Hearts Club",
	"EMA":     "Encounters: The Mysterious Airfield",
	"F":       "Fantasy",
	"FED":     "Federation",
	"FF":      "Fantasy Folk (3E)",
	...
	"GF":      "Gun Fu",
	"GG":      "Girl Genius RPG",
	"GGB":     "GURPS Ghost Busters",
	"GM":      "The Green Madonna",
	"GS":      "Gun Stats",
	"GUL":     "Gulliver Mini",
	"H":       "Horror",
	"HBP":     "Horror: Beyond the Pale",
	"HF":      "Historical Folks",
	"HMD":     "Horror: The Madness Dossier",
	"HOA":     "Hand of Asgard",
	"HOSF":    "Horror: The Old Stone Fort",
	"HOW":     "How to Be a GURPS GM",
	"HOWCE":   "How to be a GURPS GM: Combat Encounters",
	"HOWCH":   "How to be a GURPS GM: Counting Heads",
	"HOWHPO":  "How to be a GURPS GM: High-Powered Origins",
	"HOWI":    "How to be a GURPS GM: Improvising",
	"HOWME":   "How to be a GURPS GM: Managing Expectations",
	...
	"IWNR":    "Infinite Worlds: Neightreign",
	"IWOW":    "Infinite Worlds: The Osiris Worlds",
	...
	"MATCS":   "Martial Arts: Techniques Cheat-Sheet",
	...
	"RVSV":    "Renaissance Venice: Spies of Venice",
	"S":       "Space",
	...
	"SU":      "Supers",
	"SW":      "Star Wars: Core Rules",
	"SWD":     "Star Wars: Droid and Robots",
	"SWE":     "Star Wars: Equipment",
	"SWF":     "Star Wars: The Force",
	"SWS":     "Star Wars: Starships",
	"SWSS":    "Star Wars: Sentient Species",
	"T":       "Thaumatology",
