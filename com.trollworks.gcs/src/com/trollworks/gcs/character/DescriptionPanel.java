...
public class DescriptionPanel extends DropPanel {
    ...
    public DescriptionPanel(CharacterSheet sheet) {
        ...
        createLabelAndField(wrapper, sheet, Profile.ID_HEIGHT, I18n.Text("Height:"), null, SwingConstants.LEFT);
        createLabelAndField(wrapper, sheet, Profile.ID_WEIGHT, I18n.Text("Weight:"), null, SwingConstants.LEFT);
        createLabelAndField(wrapper, sheet, Profile.ID_SIZE_MODIFIER, I18n.Text("Size:"), I18n.Text("The character's size modifier"), SwingConstants.LEFT);
        createLabelAndField(wrapper, sheet, Profile.ID_TECH_LEVEL, I18n.Text("TL:"), I18n.Text("<html><body>TL0: Stone Age<br>TL1: Bronze Age<br>TL2: Iron Age<br>TL3: Medieval<br>TL4: Age of Sail<br>TL5: Industrial Revolution<br>TL6: Mechanized Age<br>TL7: Nuclear Age<br>TL8: Digital Age<br>TL9: Microtech Age<br>TL10: Robotic Age<br>TL11: Age of Exotic Matter<br>TL12: Anything Goes</body></html>"), SwingConstants.LEFT);
        add(wrapper);

        createDivider();

        wrapper = new Wrapper(new ColumnLayout(2, 2, 0));
        createLabelAndField(wrapper, sheet, Profile.ID_HAIR, I18n.Text("Hair:"), I18n.Text("The character's hair style and color"), SwingConstants.LEFT);
        createLabelAndField(wrapper, sheet, Profile.ID_EYE_COLOR, I18n.Text("Eyes:"), I18n.Text("The character's eye color"), SwingConstants.LEFT);
        createLabelAndField(wrapper, sheet, Profile.ID_SKIN_COLOR, I18n.Text("Skin:"), I18n.Text("The character's skin color"), SwingConstants.LEFT);
        createLabelAndField(wrapper, sheet, Profile.ID_HANDEDNESS, I18n.Text("Hand:"), I18n.Text("The character's preferred hand"), SwingConstants.LEFT);
        add(wrapper);
    }
