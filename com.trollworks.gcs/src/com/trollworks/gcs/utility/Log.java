...
public class Log {
    ...
    static {
        ...
        if (property != null && !property.isBlank()) {
            ...
            File directory = new File(System.getenv("LOCALAPPDATA") + "\\GCS");
            File logFile = new File(System.getenv("LOCALAPPDATA") + "\\GCS\\error.log");
            if (!directory.exists()) {
                directory.mkdir();
            }
            try {
                ...
                error("Unable to redirect log to " + logFile, throwable);
            }
        }
    }
