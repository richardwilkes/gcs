 ...
 */
public class TKNumericStringComparator implements Comparator<String> {
	/** The standard caseless, numeric-aware string comparator. */
	public static final TKNumericStringComparator	CASELESS_COMPARATOR	= new TKNumericStringComparator(true);
	/** The standard case-sensitive, numeric-aware string comparator. */
	public static final TKNumericStringComparator	COMPARATOR			= new TKNumericStringComparator(false);
	private static NumberFormat						DECIMAL_FORMATTER	= null;
	private boolean									mCaseless;

	private TKNumericStringComparator(boolean caseless) {
		mCaseless = caseless;
	}
