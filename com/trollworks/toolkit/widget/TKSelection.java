...
public class TKSelection {
	 ...
	 */
	public TKSelection(Owner owner) {
		mOwner = owner;
	 ...
	 */
	public TKSelection(Owner owner, int size) {
		this(owner);
		mSize = size;
	}
	 ...
	 */
	public TKSelection(TKSelection other) {
		mOwner = other.mOwner;
	 ...
	 * @return <code>true</code> if the specified index is selected, <code>false</code> if it
	 *         isn't.
	 */
	...
	/** @return The first selected index, or <code>-1</code> if there is none. */
	 ...
	 * @return The index of the first selected index on or after <code>fromIndex</code>, or
	...
	/** @return The last selected index, or <code>-1</code> if there is none. */
	...
	/**
	 * Selects the range <code>fromIndex</code> (inclusive) to <code>toIndex</code> (inclusive).
	 * If the selection is replaced or there was no prior selection, the anchor is set to
	 * <code>fromIndex</code>.
	 * 
	 ...
	 * @return The index that should be scrolled into view, or <code>-1</code> if there isn't one.
	 */
	...
	/**
	 * Deselects the range <code>fromIndex</code> (inclusive) to <code>toIndex</code>
	 * (inclusive).
	 * 
	...
	/**
	 * Owners of a {@link TKSelection} that want notification when the selection is modified must
