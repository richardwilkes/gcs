...
public class TKRowUndoSnapshot {
	private TKRow				mParent;
	private boolean				mOpen;
	private ArrayList<TKRow>	mChildren;
	 ...
	 */
	public TKRowUndoSnapshot(TKRow row) {
		mParent = row.getParent();
		mOpen = row.isOpen();
		mChildren = row.canHaveChildren() ? new ArrayList<TKRow>(row.getChildren()) : null;
	}

	/** @return The children. */
	public ArrayList<TKRow> getChildren() {
		return mChildren;
	}
