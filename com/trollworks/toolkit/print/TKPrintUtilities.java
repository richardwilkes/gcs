...
public class TKPrintUtilities {
	 ...
	 */
	public static TKPageOrientation getPageOrientation(PrintService service, PrintRequestAttributeSet set) {
		return TKPageOrientation.get(getSetting(service, set, OrientationRequested.class, true));
	}
	 ...
	 */
	public static void setPageOrientation(PrintRequestAttributeSet set, TKPageOrientation orientation) {
	 ...
	 */
	public static double[] getPaperMargins(PrintService service, PrintRequestAttributeSet set, TKLengthUnits units) {
		double[] size = getPaperSize(service, set, TKLengthUnits.INCHES);
		...
		return new double[] { units.convert(TKLengthUnits.INCHES, y), units.convert(TKLengthUnits.INCHES, x), units.convert(TKLengthUnits.INCHES, size[1] - (y + current.getHeight(MediaPrintableArea.INCH))), units.convert(TKLengthUnits.INCHES, size[0] - (x + current.getWidth(MediaPrintableArea.INCH))) };
	}
	 ...
	 */
	public static void setPaperMargins(PrintService service, PrintRequestAttributeSet set, double[] margins, TKLengthUnits units) {
		double[] size = getPaperSize(service, set, units);

		set.add(new MediaPrintableArea((float) TKLengthUnits.INCHES.convert(units, margins[1]), (float) TKLengthUnits.INCHES.convert(units, margins[0]), (float) TKLengthUnits.INCHES.convert(units, size[0] - (margins[1] + margins[3])), (float) TKLengthUnits.INCHES.convert(units, size[1] - (margins[0] + margins[2])), Size2DSyntax.INCH));
	}
	 ...
	 */
	public static double[] getPageMargins(PrintService service, PrintRequestAttributeSet set, TKLengthUnits units) {
		TKPageOrientation orientation = getPageOrientation(service, set);
		double[] margins = getPaperMargins(service, set, units);

		if (orientation == TKPageOrientation.LANDSCAPE) {
			return new double[] { margins[1], margins[2], margins[3], margins[0] };
		}
		if (orientation == TKPageOrientation.REVERSE_PORTRAIT) {
			return new double[] { margins[2], margins[3], margins[0], margins[1] };
		}
		if (orientation == TKPageOrientation.REVERSE_LANDSCAPE) {
	 ...
	 * @param units The type of units being used.
	 */
	public static void setPageMargins(PrintService service, PrintRequestAttributeSet set, double[] margins, TKLengthUnits units) {
		TKPageOrientation orientation = getPageOrientation(service, set);
	 ...
	 */
	public static double[] getPaperSize(PrintService service, PrintRequestAttributeSet set, TKLengthUnits units) {
	 ...
	 */
	public static double[] getMediaDimensions(Media media, TKLengthUnits units) {
		...
		return new double[] { units.convert(TKLengthUnits.INCHES, size.getX(Size2DSyntax.INCH)), units.convert(TKLengthUnits.INCHES, size.getY(Size2DSyntax.INCH)) };
	}
	 ...
	 * @param units The type of units being used.
	 */
	public static void setPaperSize(PrintService service, PrintRequestAttributeSet set, double[] size, TKLengthUnits units) {
		double[] margins = getPaperMargins(service, set, units);
		MediaSizeName mediaSizeName = MediaSize.findMedia((float) TKLengthUnits.INCHES.convert(units, size[0]), (float) TKLengthUnits.INCHES.convert(units, size[1]), Size2DSyntax.INCH);
	 ...
	 */
	public static double[] getPageSize(PrintService service, PrintRequestAttributeSet set, TKLengthUnits units) {
		TKPageOrientation orientation = getPageOrientation(service, set);
		double[] size = getPaperSize(service, set, units);

		if (orientation == TKPageOrientation.LANDSCAPE || orientation == TKPageOrientation.REVERSE_LANDSCAPE) {
			double tmp = size[0];
	 ...
	 * @param units The type of units being used.
	 */
	public static void setPageSize(PrintService service, PrintRequestAttributeSet set, double[] size, TKLengthUnits units) {
		TKPageOrientation orientation = getPageOrientation(service, set);
	 ...
	 */
	public static TKInkChromaticity getChromaticity(PrintService service, PrintRequestAttributeSet set, boolean tryDefaultIfNull) {
		return TKInkChromaticity.get(getSetting(service, set, Chromaticity.class, tryDefaultIfNull));
	}
	 ...
	 */
	public static void setChromaticity(PrintRequestAttributeSet set, TKInkChromaticity chromaticity) {
	 ...
	 * @return The sides.
	 */
	public static TKPageSides getSides(PrintService service, PrintRequestAttributeSet set) {
		return TKPageSides.get(getSetting(service, set, Sides.class, true));
	}
	 ...
	 */
	public static void setSides(PrintRequestAttributeSet set, TKPageSides sides) {
	 ...
	 */
	public static TKQuality getPrintQuality(PrintService service, PrintRequestAttributeSet set, boolean tryDefaultIfNull) {
		return TKQuality.get(getSetting(service, set, PrintQuality.class, tryDefaultIfNull));
	}
	 ...
	 */
	public static void setPrintQuality(PrintRequestAttributeSet set, TKQuality quality) {
	...
	public static int getCopies(PrintService service, PrintRequestAttributeSet set) {
		Copies copies = TKPrintUtilities.getSetting(service, set, Copies.class, false);
	...
	public static NumberUp getNumberUp(PrintService service, PrintRequestAttributeSet set) {
		return TKPrintUtilities.getSetting(service, set, NumberUp.class, false);
	}
	...
	public static PageRanges getPageRanges(PrintService service, PrintRequestAttributeSet set) {
		return TKPrintUtilities.getSetting(service, set, PageRanges.class, false);
	}
