...
public class TKUniqueID {
	 ...
	 *            {@link TKUniqueID}.
	 */
	public TKUniqueID(String uniqueID) {
		try {
	 ...
	 */
	public TKUniqueID(long timeStamp, long subID) {
	...
	@Override public final boolean equals(Object obj) {
		...
		if (obj instanceof TKUniqueID) {
			TKUniqueID other = (TKUniqueID) obj;
	 ...
	 * @return <code>true</code> if the passed-in object is also a {@link TKUniqueID} and their
	 *         sub-ID's match.
	 */
	...
	/**
	 * @param obj The object to check.
	 * @return <code>true</code> if the passed-in object is also a {@link TKUniqueID}, their
