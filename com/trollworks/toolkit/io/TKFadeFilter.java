...
public class TKFadeFilter extends RGBImageFilter {
	 ...
	 */
	public TKFadeFilter(int percentage, boolean useWhite) {
	...
	public static BufferedImage createFadedImage(BufferedImage image, int percentage, boolean useWhite) {
		TKFadeFilter filter = new TKFadeFilter(percentage, useWhite);
