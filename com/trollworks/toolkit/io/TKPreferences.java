...
import com.trollworks.toolkit.utility.TKConversion;
...
public class TKPreferences {
	private static final String		VERSION_KEY	= "Version";	//$NON-NLS-1$
	private static final String		DOT			= ".";			//$NON-NLS-1$
	private static TKPreferences	INSTANCE	= null;
	...
	public static synchronized TKPreferences getInstance() {
		if (INSTANCE == null) {
			throw new RuntimeException(Msgs.UNINITIALIZED);
		}
		return INSTANCE;
	}
	...
	public static synchronized void setPreferenceFile(File prefsFile) {
		if (INSTANCE == null) {
			INSTANCE = new TKPreferences(prefsFile);
		}
	}
	 ...
	 * @param prefsFile The file containing preferences.
	 */
	public TKPreferences(File prefsFile) {
		mFile = prefsFile;
	 ...
	 * @param module The module to work with.
	 * @param key The key this preference is tied to.
	 * @return The specified preference as a {@link Color}. <code>null</code> will be returned if
	 *         the key cannot be extracted.
	 */
	public Color getColorValue(String module, String key) {
		return getColorValue(module, key, null);
	}
	 ...
	 * @param key The key this preference is tied to.
	 * @param defaultValue The default value to return if the key cannot be extracted.
	 * @return The specified preference as a {@link Color}.
	 */
	public Color getColorValue(String module, String key, Color defaultValue) {
		Color color = TKColor.extractColor(getStringValue(module, key));
	...
	public Dimension getDimensionValue(String module, String key, Dimension defaultValue) {
		Dimension dim = TKConversion.extractDimension(getStringValue(module, key));
	...
	public Font getFontValue(String module, String key) {
		...
		return value == null ? null : TKFont.create(value);
	}
	...
	public Font getFontValue(String module, String key, Font defaultValue) {
		return TKFont.create(getStringValue(module, key), defaultValue);
	}
	...
	public Point getPointValue(String module, String key, Point defaultValue) {
		Point pt = TKConversion.extractPoint(getStringValue(module, key));
	...
	public boolean save() {
		if (mDirty) {
			try {
				TKSafeFileUpdater trans = new TKSafeFileUpdater();
				...
				try {
					...
					mPrefs.storeToXML(out, TKApp.getName());
					out.close();
	...
	/**
	 * Sets the specified preference as a <code>Color</code>.
	 * 
	 * @param module The module to work with.
	 * @param key The key this preference is tied to.
	 * @param value The value to set the key to.
	 */
	public void setValue(String module, String key, Color value) {
		setValue(module, key, value != null ? TKColor.getStringValue(value) : null);
	}
	...
	public void setValue(String module, String key, Dimension value) {
		setValue(module, key, value != null ? TKConversion.createString(value) : null);
	}
	...
	public void setValue(String module, String key, Font value) {
		setValue(module, key, value != null ? TKFont.getStringValue(value) : null);
	}
