...
public class CMLeveledAmount {
	 ...
	 */
	public CMLeveledAmount(double amount) {
		mPerLevel = false;
		mLevel = 0;
		mAmount = amount;
		mInteger = false;
	 ...
	 * @param amount The initial amount.
	 */
	public CMLeveledAmount(int amount) {
		this((double) amount);
		mInteger = true;
	}
	 ...
	 * Creates a new leveled amount.
	 * 
	 * @param other A {@link CMLeveledAmount} to clone.
	 */
	public CMLeveledAmount(CMLeveledAmount other) {
	...
	@Override public boolean equals(Object obj) {
		...
		if (obj instanceof CMLeveledAmount) {
			CMLeveledAmount other = (CMLeveledAmount) obj;
	...
	public String getAmountAsString() {
		if (mInteger) {
			return TKNumberUtils.format(getIntegerAmount(), true);
		}
		return TKNumberUtils.format(mAmount, true);
	}
