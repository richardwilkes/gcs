 ...
 * information for a {@link CMWeaponDisplayRow}.
 */
public class CMWeaponDescriptionCell implements TKCell {
	 ...
	 */
	protected String getPrimaryText(CMWeaponDisplayRow row) {
	 ...
	 */
	protected String getSecondaryText(CMWeaponDisplayRow row) {
	...
	public void drawCell(Graphics2D g2d, Rectangle bounds, TKRow row, TKColumn column, boolean selected, boolean active) {
		CMWeaponDisplayRow theRow = (CMWeaponDisplayRow) row;
	...
	private String wrap(CMWeaponDisplayRow row, TKColumn column, String text, Font font) {
	...
	public int compare(TKColumn column, TKRow one, TKRow two) {
		CMWeaponDisplayRow r1 = (CMWeaponDisplayRow) one;
		CMWeaponDisplayRow r2 = (CMWeaponDisplayRow) two;
