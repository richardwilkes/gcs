...
public class CMRangedWeaponStats extends CMWeaponStats {
	/** The root XML tag. */
	...
	/**
	 * Creates a new {@link CMRangedWeaponStats}.
	 * 
	 * @param owner The owning piece of equipment or advantage.
	 */
	public CMRangedWeaponStats(CMRow owner) {
		super(owner);
	}

	/**
	 * Creates a clone of the specified {@link CMRangedWeaponStats}.
	 * 
	 * @param owner The owning piece of equipment or advantage.
	 * @param other The {@link CMRangedWeaponStats} to clone.
	 */
	public CMRangedWeaponStats(CMRow owner, CMRangedWeaponStats other) {
		super(owner, other);
	...
	/**
	 * Creates a {@link CMRangedWeaponStats}.
	 * 
	 * @param owner The owning piece of equipment or advantage.
	 * @param reader The reader to load from.
	 * @throws IOException
	 */
	public CMRangedWeaponStats(CMRow owner, TKXMLReader reader) throws IOException {
		super(owner, reader);
	}
	...
	public String getResolvedRange() {
		...
		if (df instanceof CMCharacter) {
			int strength = ((CMCharacter) df).getStrength();
			String savedRange;
		...
		if (where != -1) {
			...
			if (last < max) {
				...
				if (found) {
					...
					strength *= value;
					buffer.append(TKNumberUtils.format(strength));
					if (last < max) {
	...
	@Override public boolean equals(Object obj) {
		...
		if (obj instanceof CMRangedWeaponStats) {
			CMRangedWeaponStats other = (CMRangedWeaponStats) obj;
