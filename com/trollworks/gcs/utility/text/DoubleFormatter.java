...
public class DoubleFormatter extends JFormattedTextField.AbstractFormatter {
	...
	@Override public Object stringToValue(String text) throws ParseException {
		return new Double(Math.min(Math.max(NumberUtils.getDouble(text, mMinValue <= 0 && mMaxValue >= 0 ? 0 : mMinValue), mMinValue), mMaxValue));
	}

	@Override public String valueToString(Object value) throws ParseException {
		return NumberUtils.format(((Double) value).doubleValue(), mForceSign);
	}
}
