...
package com.trollworks.gcs.utility.io.xml;
...
public class XMLReader {
	...
	public static boolean			SHOW_SKIPPED_TAGS	= NumberUtils.getBoolean(System.getProperty("SHOW_SKIPPED_TAGS", "false"));	//$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * <code>true</code> and required type is not {@link XMLNodeType#TEXT}, then
	...
	public boolean readBoolean() throws IOException {
		return NumberUtils.getBoolean(readText());
	}
	...
	public short readShort(short defValue) throws IOException {
		return NumberUtils.getNonLocalizedShort(readText(), defValue);
	}
	...
	public int readInteger(int defValue) throws IOException {
		return NumberUtils.getNonLocalizedInteger(readText(), defValue);
	}
	...
	public long readLong(long defValue) throws IOException {
		return NumberUtils.getNonLocalizedLong(readText(), defValue);
	}
	...
	public float readFloat(float defValue) throws IOException {
		return NumberUtils.getNonLocalizedFloat(readText(), defValue);
	}
	...
	public double readDouble(double defValue) throws IOException {
		return NumberUtils.getNonLocalizedDouble(readText(), defValue);
	}
	...
	public boolean isAttributeSet(String name) {
		return NumberUtils.getBoolean(mAttributeMap.get(name));
	}
	...
	public short getAttributeAsShort(String name, short defValue) {
		return NumberUtils.getNonLocalizedShort(mAttributeMap.get(name), defValue);
	}
	...
	public int getAttributeAsInteger(String name, int defValue) {
		return NumberUtils.getNonLocalizedInteger(mAttributeMap.get(name), defValue);
	}
	...
	public long getAttributeAsLong(String name, long defValue) {
		return NumberUtils.getNonLocalizedLong(mAttributeMap.get(name), defValue);
	}
	...
	public float getAttributeAsFloat(String name, float defValue) {
		return NumberUtils.getNonLocalizedFloat(mAttributeMap.get(name), defValue);
	}
	...
	public double getAttributeAsDouble(String name, double defValue) {
		return NumberUtils.getNonLocalizedDouble(mAttributeMap.get(name), defValue);
	}
