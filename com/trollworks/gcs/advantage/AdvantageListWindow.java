...
public class AdvantageListWindow extends ListWindow implements BatchNotifierTarget {
	...
	static {
		LocalizedMessages.initialize(AdvantageListWindow.class);
	}
	 ...
	 */
	public AdvantageListWindow(AdvantageList list) {
	...
	@Override protected ListOutline createOutline() {
		return new AdvantageOutline(mListFile);
	}
