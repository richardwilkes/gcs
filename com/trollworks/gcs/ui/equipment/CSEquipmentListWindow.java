...
public class CSEquipmentListWindow extends CSListWindow {
	/**
	 * Creates a list window.
	 * 
	 * @param list The list to display.
	 */
	public CSEquipmentListWindow(CMEquipmentList list) {
		super(list, CMD_NEW_EQUIPMENT, CMD_NEW_EQUIPMENT_CONTAINER);
	}

	@Override protected CSOutline createOutline() {
		return new CSEquipmentOutline(mListFile, false);
	}
	...
	@Override public TKFileFilter[] getFileFilters() {
		return new TKFileFilter[] { CSListOpener.FILTERS[CSListOpener.EQUIPMENT_FILTER] };
	}
}
