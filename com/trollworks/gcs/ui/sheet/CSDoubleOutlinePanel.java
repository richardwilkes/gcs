...
public class CSDoubleOutlinePanel extends TKPanel implements LayoutManager2 {
	private CSSingleOutlinePanel	mLeftPanel;
	private CSSingleOutlinePanel	mRightPanel;
	 ...
	 */
	public CSDoubleOutlinePanel(TKOutline leftOutline, String leftTitle, TKOutline rightOutline, String rightTitle, boolean useProxy) {
		super();
		setLayout(this);
		mLeftPanel = new CSSingleOutlinePanel(leftOutline, leftTitle, useProxy);
		mRightPanel = new CSSingleOutlinePanel(rightOutline, rightTitle, useProxy);
		add(mLeftPanel);
		add(mRightPanel);
	}
