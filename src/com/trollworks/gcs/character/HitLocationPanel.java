...
public class HitLocationPanel extends DropPanel {
    ...
    @Localize(locale = "de",
              value = "<html><body>Der Würfelwurf, um die Trefferzone <b>{0}</b> zu treffen</body></html>")
    @Localize(locale = "ru",
              value = "<html><body>Для попадания в <b>{0}</b>, необходимо сделать дополнительный бросок (ДБ) и выбросить указанные числа</body></html>")
    @Localize(locale = "es",
              value = "<html><body>Tirada al azar requerida para alcanzar la localización del impacto <b>{0}</b></body></html>")
    ...
    @Localize(locale = "de",
              value = "Der Treffernachteil für das Zielen auf eine spezifische Trefferzone")
    @Localize(locale = "ru", value = "Штраф для попадания в указанную зону")
    @Localize(locale = "es",
              value = "Penalización a la tirada por apuntar a una determinada localización de impacto")
    ...
    @Localize(locale = "de",
              value = "<html><body>Der Treffernachteil für das Zielen auf die Trefferzone <b>{0}</b></body></html>")
    @Localize(locale = "ru",
              value = "<html><body>Штраф за прицеливания в зону попадания <b>{0}</b></body></html>")
    @Localize(locale = "es",
              value = "<html><body>penalización a la tirada por apuntar a <b>{0}</b></body></html>")
    ...
    @Localize(locale = "de",
              value = "<html><body>Die Gesamte Schadensresistenz, die die Trefferzone <b>{0}</b> schützt</body></html>")
    @Localize(locale = "ru",
              value = "<html><body>Суммарное СП, защищающее зону попадания: <b>{0}</b></body></html>")
