...
public class HitPointsPanel extends DropPanel {
    ...
    @Localize(locale = "de",
              value = "<html><body>Normale (d.h. unverletzt) Trefferpunke.<br><b>{0} Punkte</b> wurden für die Veränderung von <b>TP</b> aufgewendet</body></html>")
    @Localize(locale = "ru",
              value = "<html><body>Обычные единицы жизни (т.е. персонаж невредимый).<br><b>{0} очков</b> использовано на изменение <b>ЗД</b></body></html>")
    @Localize(locale = "es",
              value = "<html><body>Puntos de Vida normales (p.e. ileso).<br><b>{0} puntos</b> que se han consumido para modificar <b>PV</b></body></html>")
    ...
    @Localize(locale = "de",
              value = "<html><body>Wenn die aktuellen Trefferpunkte auf diesem Wert oder geringer sind,<br>bedeutet dies, dass der Charakter vor Schmerzen taumelt,<br>was Bewegungspunkte, Geschwindigkeit und Ausweichen halbiert</body></html>")
    @Localize(locale = "ru",
              value = "<html><body>ЕЖ, меньшее или равное этому числу означает, что персонаж<br>измотан, и имеет половину движения, скорости и уклонения</body></html>")
    @Localize(locale = "es",
              value = "<html><body>Con estos puntos de vida o menos, el personaje está aturdido<br>por el dolor, por lo que reduce movimiento, velocidad y parada a la mitad</body></html>")
    ...
    @Localize(locale = "de",
              value = "<html><body>Wenn die aktuellen Trefferpunkte auf diesem Wert oder geringer sind,<br>bedeutet dies, dass der Charakter vor dem Kollaps steht,<br>wodurch der Charakter jede Sekunde <b>eine KO-Probe</b><br>(mit -1 für jedes Vielfache der TP unter Null) bestehen muss,<br>um nicht in Ohnmacht zu fallen.</body></html>")
    @Localize(locale = "ru",
              value = "<html><body>ЕЖ, меньшее или равное этому числу означает, что персонаж <br>почти истощен и должен <b>делать бросок ЗД</b> (-1 за каждое полное <br>кратное ЗД ниже нуля) каждую секунду, чтобы не упасть без сознания</body></html>")
    @Localize(locale = "es",
              value = "<html><body>Con estos Puntos de Fatiga o menos, el personaje está al<br>borde del colapso, por lo que realizará una <b>tirada contra SL</b><br>(con -1 por cada múltiplo completo de los PV totales por debajo de cero)<br>cada segundo para evitar caer inconsciente</body></html>")
    ...
    @Localize(locale = "de",
              value = "<html><body>Wenn die aktuellen Trefferpunkte auf diesem Wert oder geringer sind,<br>muss der Charakter <b>eine KO-Probe</b> bestehen, um nicht zu sterben.</body></html>")
    @Localize(locale = "ru",
              value = "<html><body>ЕЖ, меньшее или равное этому числу означает, что персонажу<br>нужно <b>сделать бросок ЗД</b> для избежания смерти</body></html>")
    @Localize(locale = "es",
              value = "<html><body>Con estos puntos de Vida o menos, el personaje<br>realizará una <b>tirada contra SL</b> para evitar caer muerto</body></html>")
    ...
    @Localize(locale = "de",
              value = "<html><body>Wenn die aktuellen Trefferpunkte auf diesem Wert oder geringer sind,<br>stirbt der Charakter.</body></html>")
    @Localize(locale = "ru",
              value = "<html><body>ЕЖ, меньшее или равное этому числу означает<br>смерть персонажа</body></html>")
    @Localize(locale = "es",
              value = "<html><body>Con estos puntos de Vida o menos, el personaje caerá muerto</body></html>")
    ...
    @Localize(locale = "de",
              value = "<html><body>Normale (d.h. ausgeruhte) Erschöpfungspunkte.<br><b>{0} Punkte</b> wurden für die Veränderung von <b>FP</b> aufgewendet</body></html>")
    @Localize(locale = "ru",
              value = "<html><body>Обычные единицы усталости (т.е. полностью отдохнувший персонаж).<br><b>{0} очков</b> использовано на изменение <b>ЕУ</b></body></html>")
    @Localize(locale = "es",
              value = "<html><body>Puntos de Fatiga normales (p.e. descansado).<br><b>{0} puntos</b> que se han consumido para modificar <b>PV</b></body></html>")
    ...
    @Localize(locale = "de",
              value = "<html><body>Wenn die aktuellen Trefferpunkte auf diesem Wert oder geringer sind,<br>bedeutet dies, dass der Charakter sehr müde ist, was seine Bewegung,<br>ausweichen und Stärke halbiert.</body></html>")
    @Localize(locale = "ru",
              value = "<html><body>ЕУ, меньшее или равное этому числу означает, что персонаж почти<br>истощен. Движение, уклонение и сила уменьшаются вдвое</body></html>")
    @Localize(locale = "es",
              value = "<html><body>Con estos Puntos de Fatiga o menos, el personaje está muy<br>cansado, , por lo que reduce movimiento, parada y fuerza a la mitad</body></html>")
    ...
    @Localize(locale = "de",
              value = "<html><body>Wenn die aktuellen Erschöpfungspunkte auf diesem Wert oder geringer sind,<br>bedeutet dies, dass der Charakter vor dem Kollaps steht,<br>wodurch der Charakter jedes mal, wenn er etwas anderes macht<br>als reden oder ausruhen, <b>eine Willens-Probe</b> bestehen muss.</body></html>")
    @Localize(locale = "ru",
              value = "<html><body>ЕУ, меньшее или равное этому числу означает, что персонаж<br>почти истощен, и персонаж делает бросок Воли,<br>чтобы сделать что-либо, кроме отдыха и разговора.</body></html>")
    @Localize(locale = "es",
              value = "<html><body>Con estos Puntos de Fatiga o menos, el personaje está al<br>borde del colapso, por lo que deberá tirar contra<br>Voluntad para realizar cualquier actividad más allá de hablar o descansar</body></html>")
    ...
    @Localize(locale = "de",
              value = "<html><body>Wenn die aktuellen Trefferpunkte auf diesem Wert oder geringer sind,<br>wird der Charakter bewusstlos.</body></html>")
    @Localize(locale = "ru",
              value = "<html><body>ЕУ, меньшее или равное этому числу<br>означает, что персонаж теряет сознание</body></html>")
    @Localize(locale = "es",
              value = "<html><body>Con estos Puntos de Fatiga o menos<br>, el personaje cae incosnciente</body></html>")
