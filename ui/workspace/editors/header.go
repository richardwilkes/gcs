...
func NewHeader[T gurps.NodeTypes](title, tooltip string, forPage bool) unison.TableColumnHeader[*ntable.Node[T]] {
	if forPage {
...
func NewSVGHeader[T gurps.NodeTypes](svg *unison.SVG, tooltip string, forPage bool) unison.TableColumnHeader[*ntable.Node[T]] {
	if forPage {
...
func NewSVGPairHeader[T gurps.NodeTypes](leftSVG, rightSVG *unison.SVG, tooltip string, forPage bool) unison.TableColumnHeader[*ntable.Node[T]] {
	if forPage {
		header := NewPageTableColumnHeader[T]("", tooltip)
		baseline := header.Font.Baseline()
...
func NewPageRefHeader[T gurps.NodeTypes](forPage bool) unison.TableColumnHeader[*ntable.Node[T]] {
	return NewSVGHeader[T](res.BookmarkSVG, gurps.PageRefTooltipText, forPage)
}

// NewEquippedHeader creates a new equipped header.
func NewEquippedHeader[T gurps.NodeTypes](forPage bool) unison.TableColumnHeader[*ntable.Node[T]] {
...
func NewEnabledHeader[T gurps.NodeTypes](forPage bool) unison.TableColumnHeader[*ntable.Node[T]] {
	return NewSVGHeader[T](res.CheckmarkSVG,
...
func NewMoneyHeader[T gurps.NodeTypes](forPage bool) unison.TableColumnHeader[*ntable.Node[T]] {
...
func NewExtendedMoneyHeader[T gurps.NodeTypes](forPage bool) unison.TableColumnHeader[*ntable.Node[T]] {
...
func NewWeightHeader[T gurps.NodeTypes](forPage bool) unison.TableColumnHeader[*ntable.Node[T]] {
...
func NewExtendedWeightHeader[T gurps.NodeTypes](forPage bool) unison.TableColumnHeader[*ntable.Node[T]] {
